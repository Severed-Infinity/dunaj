...
(ns clojure.dunaj-deftype
  (:refer-clojure :exclude
    [extend-protocol extend-type extend defprotocol -reset-methods
     find-protocol-methods extends? extenders satisfies?
     -cache-protocol-fn find-protocol-method find-protocol-impl
     deftype record? defrecord namespace-munge definterface
     reify hash-combine munge]))
...
(def shift-mask @#'clojure.core/shift-mask)
(def maybe-min-hash @#'clojure.core/maybe-min-hash)
(def maybe-destructured @#'clojure.core/maybe-destructured)
